...
let imageUrl = URL("string:https://ss0.baidu.com/7Po3dSag_xI4khGko9WTAnF6hhy/image/h%3D300/sign=bdb1172ebd7eca800d053fe7a1229712/5fdf8db1cb134954068359695b4e9258d1094a19.jpg”)

let urlData = try Data(contentsOf:imageUrl!)    //将json数据转换为二进制数据

let fileManager = FileManager.default

var path = fileManager.urls(for: .documentDirectory, in:.userDomainMask).first!

path.appendPathComponent(“girl.jpg”)
print(path)
